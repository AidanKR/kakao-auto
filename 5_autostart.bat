...
REM 1) 로그인 시 수집기 자동시작 = '시작프로그램' 폴더에 실행기 등록(관리자 불필요, 화면세션 보장)
set "STARTUP=%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup"
echo [1/6] 시작프로그램에 수집기 자동시작 등록...
...
echo  작업 해제:  schtasks /Delete /TN KakaoHealthCheck /F  (등)
pause
